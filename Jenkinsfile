pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'kavyashree18/ecommerce-app'   // Your Docker Hub repo
    }
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker-hub-credentials', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                    sh '''
                        ...
                        docker push kavyashree18/ecommerce-app:${BUILD_NUMBER}
                        docker push kavyashree18/ecommerce-app:latest
                    '''
                }
            }
        }
